  ...
  return (
    <div className='grid gap-y-10'>
        <div className='mt-12'>
          ...
          <div className='flex items-center justify-between border pl-3 mt-4'>
            Aadhar card
            <div className='flex items-center gap-2 bg-gray-200 p-2'><IoDocumentOutline/> View document</div>
          </div>
          <div className='flex items-center justify-between border pl-3 mt-4'>
            PAN card
            <div className='flex items-center gap-2 bg-gray-200 p-2'><IoDocumentOutline/> View document</div>
